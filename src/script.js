// Looks much better in full screen!
...
new Vue ({
  ...
  methods: {
    ...
    marsAnimation: function () {
      ...
      let planetTL = new TimelineMax({repeat: -1});
    ...
    coordinates: function (e) {
      ...
      let drawingXCenter = drawingBox.width / 2 + drawingBox.left;
    ...
    getMaxDistanceX: function () {
      ...
      const svg = document.querySelector('#ziggy-main');
      let svgWidth = svg.getBoundingClientRect().width;
      this.maxDistanceX = svgWidth / 2;
    ...
    loadEvents: function () {
      // FIXME later, it's so ugly :P
      window.addEventListener('resize', this.resetCanvas, false);
      document.querySelector('#ziggy-main').addEventListener('touchmove', this.coordinates);
      document.querySelector('#ziggy-main').addEventListener('touchstart', this.coordinates);
      document.querySelector('#sticker').addEventListener('touchstart', this.handleClickSticker);
      document.querySelector('#space-planet-overlay').addEventListener('touchstart', this.changeTheme);
    }
